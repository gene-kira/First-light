...
# - Behavioral anomaly detection (IsolationForest with safe patch)
...
# ============================================================
# 5. ML MODEL WRAPPER + BEHAVIORAL ML (PATCHED) + LLM
# ============================================================
...
class BehavioralML:
    """
    Safe IsolationForest anomaly detection.
    Prevents 'estimators_' errors by auto-training on first use.
    """
    def __init__(self, autoloader: AutoLoader):
        self.autoloader = autoloader
