...
THREAT_INTEL_CACHE = DATA_DIR / "threat_intel.json"
...
class SecurityConfig:
    def __init__(self):
        ...
        self.threat_intel_url = ""  # you can set a safe public feed URL here
...
class SecurityGUI:
    ...
    def _about_tab(self, parent):
        text = (
            ...
            "Heatmaps, lineage graphs, GPU curves, threat intel, auto-tagging, and AI remediation\n"
            "suggestions turn this into a full defensive command center.\n"
        )
    ...
    def _refresh_gpu_curves(self):
        ...
        if not curves:
            self.gpu_curve_canvas.create_text(w / 2, h / 2, text="No GPU curve data yet.", fill="#ffffff")
            return
