...
system-wide icon pack manager, permissions analyzer, and registry-based
Explorer tweaks.
...
import os, sys, json, time, hashlib, shutil, subprocess, traceback
...
class App:
    def __init__(self):
        ...
        self.root.geometry("1200x820"); self.root.minsize(900, 600)
