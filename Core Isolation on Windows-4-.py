...
def get_security_readiness_score():
    """
    Simple scoring for GPU governor integration:
    - HVCI ON: +30
    - Secure Boot ON: +20
    - TPM Present: +20
    - TPM Ready: +10
    - BitLocker Global enabled (non-Unknown, non-0): +10
    - No driver blockers: +10
...
class SecurityGovernorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Security Governor / Sentinel")
