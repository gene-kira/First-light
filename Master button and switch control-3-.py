#!/usr/bin/env python
# Codex Purge Shell — Win11 Security Bridge (Suricata v6, NDIS stub, GPU DL, Agentic, Honeypot, GPO, Telemetry)
...
class SuricataEventIngestor:
    ...
    Expects Suricata to emit JSON logs to eve.json.
    """
...
class NDISControlPlane:
    """
    Stub for NDIS-like control plane.
    Real kernel-level hooks are not implemented here; this is a logical model.
    """
...
class CodexSettingsGuard:
    def __init__(self, root):
        ...
        self.process_seen = {}  # pid -> last_seen_time
    ...
    def _build_ui(self):
        ...
        title = ttk.Label(
            top_frame,
            text="Codex Purge Shell — Windows 11 Security Bridge (Suricata v6, NDIS stub, GPU DL, Agentic)",
            font=("Arial", 18)
        )
    ...
    def _on_event_bus(self, evt):
        # For now, just log high-level events
        etype = evt.get("type")
