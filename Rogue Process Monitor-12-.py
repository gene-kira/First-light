...
#
# - Auto-installs psutil, matplotlib, scikit-learn, tk if missing
# - Borg Queen + workers for parallel scanning
# - Heuristic anomaly + ML anomaly (IsolationForest)
# - Threat matrix, timeline buckets, AI insights
# - Matplotlib plots for threat level and bucketed activity
# - No killing or blocking of processes
# ============================================================
