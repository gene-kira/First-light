...
# ----------------- SETTINGS DIALOG (DARK THEME FIX) -----------------
...
class SettingsDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        # FULL DARK THEME FOR SETTINGS WINDOW
        self.setStyleSheet("""
            QDialog {
    ...
    def get_settings(self):
        return {
            "blocked_paths": [l.strip() for l in self.txt_paths.toPlainText().splitlines() if l.strip()],
            "blocked_ips": [l.strip() for l in self.txt_ips.toPlainText().splitlines() if l.strip()],
...
class StatusGUI(QtWidgets.QWidget):
    ...
    def apply_theme(self):
        ...
        self.setStyleSheet("""
            QLabel { color: white; }
            QTextEdit { color: white; background-color: #202020; }
            QListWidget { color: white; background-color: #202020; }
