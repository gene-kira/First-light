#!/usr/bin/env python3
# ================================================================
#  PREEMPTIVE STRIKE AI — ULTRA NEXT-GEN v8 (Qt Edition)
...
#  Smart PID-based app/game detection (no manual game profiles required)
# ================================================================
...
# (Still available, but now optional — AI can infer games via PID)
# ================================================================
...
class ProcessObserver:
    ...
    def _get_active_process(self):
        if self.is_windows and self.ctypes is not None:
            ...
            # Fallback: highest CPU process as "active"
    ...
    def _classify_app(self, proc_info: dict):
        ...
        if any(x in name for x in ["steam", "epic", "battle.net", "origin"]):
            return "launcher"
        # Heuristic: treat .exe under common game folders as "game"
        if any(x in exe for x in ["\\steamapps\\", "\\epic games\\", "\\origin games\\", "\\gog games\\"]):
            return "game"
        # If high CPU and not system, maybe game or heavy app
        try:
...
class PreemptiveStrikeAI:
    ...
    def _observe_active_app(self):
        ...
        # Use active app to feed RL / predictor
        ...
        if app_type == "email":
            ...
            # Use process name as game identifier
    ...
    def loop(self):
        while self.running:
            try:
                ...
                # Smart PID-based observation of what you're actually doing
...
class PreemptiveMainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Manual actions / training (still available)
