#!/usr/bin/env python3
# ================================================================
#  PREEMPTIVE STRIKE AI — ULTRA NEXT-GEN v5 (Qt Edition)
...
#  Day-Phased Behavior: Day 1 Observe, Day 2 Compare, Day 3+ Predict & Act
# ================================================================
    ...
    def loop(self):
        while self.running:
            try:
                ...
                # Day-phased behavior:
                # Day 1: observe only (no predictions)
                # Day 2: compare & train, but no actions
                # Day 3+: predict & act
                if days < 1.0:
                    # Observation only
                    self.deck.push_telemetry({
                        "ts": time.time(),
                    ...
                    # Comparison & training, but no execution
                    ...
                    # Full reasoning: predict + multi-step plan + execute
                    prediction, confidence = self.predictor.predict_with_uncertainty()
...
class PreemptiveMainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Telemetry
        tele_label = QLabel("Telemetry / Reasoning")
