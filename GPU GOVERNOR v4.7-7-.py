...
# NEW:
# - CUDA kernel benchmark calibrator for FLOP estimates
# - Fan curve learning (regression-based, safe)
# - REST API for remote cluster control & telemetry dashboards
# - Plugin sandboxing wrapper
# - Adaptive undervolt curves per-GPU
# ============================================================
...
def log_telemetry_csv(row: Dict[str, Any]):
    header = [
        ...
        "calibrated_flops_factor", "undervolt_mv"
    ]
    with CSV_LOCK:
...
class GovernorGUI(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.setWindowTitle("GPU Governor v8.4 — Multi-GPU AI/HC/Gaming")
    ...
    def _on_export(self):
        ...
        any_gov.export_curve(str(BASE_DIR / "curve_v8_4.json"))
