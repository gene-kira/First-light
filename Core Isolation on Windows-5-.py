...
class SecuritySentinelClient:
    """
    Thin integration layer for DominionDeck GPU governor:
    - get_security_snapshot()
    - get_security_readiness_score()
    - is_hvci_enabled()
    """
...
class GPUGovernor:
    """
    Simple GPU telemetry + readiness view.
    For real stack, you’d plug in NVML/ADL/etc.
    """
